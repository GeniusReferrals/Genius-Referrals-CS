...
namespace GeniusReferrals.UWP.Controllers
{
    public partial class CampaignsController: BaseController
    {
        ...
        /// </summary>
        internal static CampaignsController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// <param name="campaignSlug">Required parameter: The campaign identifier</param>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic GetCampaign(string accountSlug, string campaignSlug)
        {
            Task<dynamic> t = GetCampaignAsync(accountSlug, campaignSlug);
        ...
        /// <param name="campaignSlug">Required parameter: The campaign identifier</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> GetCampaignAsync(string accountSlug, string campaignSlug)
        {
        ...
        /// <param name="sort">Optional parameter: Allowed fields: campaign_slug, created, start_date, end_date, is_active. Use sort query-string parameter that contains a delimited set of property names. For each property name, sort in ascending order, and for each property prefixed with a dash ('-') sort in descending order. Separate each property name with a vertical bar ('\|'), which is consistent with the separation of the name\|value pairs in filtering, above. For example, if we want to retrieve users in order of their last name (ascending), first name (ascending) and hire date (descending), the request might look like this www.example.com/users?sort='last_name\|first_name\|-hire_date'</param>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic GetCampaigns(
                ...
                string sort = null)
        {
            Task<dynamic> t = GetCampaignsAsync(accountSlug, page, limit, filter, sort);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
