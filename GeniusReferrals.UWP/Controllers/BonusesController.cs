...
namespace GeniusReferrals.UWP.Controllers
{
    public partial class BonusesController: BaseController
    {
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic PostBonus(string accountSlug, BonusesForm bonusesForm)
        {
            Task<dynamic> t = PostBonusAsync(accountSlug, bonusesForm);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="bonusesForm">Required parameter: The body of the request</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> PostBonusAsync(string accountSlug, BonusesForm bonusesForm)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
        ...
        public Stream GetBonusCheckup(
                string accountSlug,
                string advocateToken,
                string reference,
                double paymentAmount)
        {
            Task<Stream> t = GetBonusCheckupAsync(accountSlug, advocateToken, reference, paymentAmount);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic PostForceBonus(string accountSlug, ForceBonusesForm bonusForm)
        {
            Task<dynamic> t = PostForceBonusAsync(accountSlug, bonusForm);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="bonusForm">Required parameter: The body of the request</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> PostForceBonusAsync(string accountSlug, ForceBonusesForm bonusForm)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic GetBonusTrace(string accountSlug, int traceId)
        {
            Task<dynamic> t = GetBonusTraceAsync(accountSlug, traceId);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="traceId">Required parameter: The trace id</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> GetBonusTraceAsync(string accountSlug, int traceId)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
        ...
        public dynamic GetBonusTraces(
                ...
                string sort = null)
        {
            Task<dynamic> t = GetBonusTracesAsync(accountSlug, page, limit, filter, sort);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="sort">Optional parameter: Allowed fields: created. Use sort query-string parameter that contains a delimited set of property names. For each property name, sort in ascending order, and for each property prefixed with a dash ('-') sort in descending order. Separate each property name with a vertical bar ('\|'), which is consistent with the separation of the name\|value pairs in filtering, above. For example, if we want to retrieve users in order of their last name (ascending), first name (ascending) and hire date (descending), the request might look like this www.example.com/users?sort='last_name\|first_name\|-hire_date'</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> GetBonusTracesAsync(
                string accountSlug,
                int? page = 1,
                int? limit = 10,
                string filter = null,
