...
namespace GeniusReferrals.UWP.Controllers
{
    public partial class ReferralsController: BaseController
    {
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic PostReferral(string accountSlug, string advocateToken, ReferralForm referralForm)
        {
            Task<dynamic> t = PostReferralAsync(accountSlug, advocateToken, referralForm);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
